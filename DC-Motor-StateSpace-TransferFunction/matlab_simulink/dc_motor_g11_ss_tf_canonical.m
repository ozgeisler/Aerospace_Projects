...
G11_fromMIMO = ss(A, B(:,1), C(1,:), D(1,1));
G11_fromCanon = ss(Atilde, Btilde, Ctilde, Dtilde);

diff_tf = minreal(tf(G11_fromMIMO) - tf(G11_fromCanon));
disp("minreal( G11_fromMIMO - G11_fromCanon ) = ")
diff_tf
